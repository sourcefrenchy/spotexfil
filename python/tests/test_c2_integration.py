...
from spotexfil import protocol as proto
from spotexfil.implant import Implant
from spotexfil.operator import Operator
...
class TestC2Roundtrip:
    def test_shell_command_cycle(self, operator, implant, fake_store):
        """Operator sends shell cmd, implant executes, gets result."""
        ...
        with patch('spotexfil.modules.shell.subprocess.run',
